...
<div style={{ position: "relative", display: "flex", alignItems: "center" }}>
              ...
              <button
                ...
                style={{
                  position: "absolute", right: 12, background: "none", border: "none", cursor: "pointer", color: "rgba(255,255,255,0.4)", display: "flex", alignItems: "center", justifyContent: "center"
                }}
              >
                {showPassword ? (
                  // Eye Open SVG
            ...
            {errors.password && <span style={{ color: "#EF4444", fontSize: 11, marginTop: 4, display: "block" }}>{errors.password.message}</span>}
          </div>
